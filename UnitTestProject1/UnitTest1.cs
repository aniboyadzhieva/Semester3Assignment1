...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void TestIsbn13MethodShorterThan13()
        {
            Book book7 = new Book("Duck", "Smith", 60, "000000000");
            string actualResult = book7.Isbn13;
            Assert.AreEqual(typeof(ArgumentException), actualResult);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void TestIsbn13MethodLongerThan13()
        {
            Book book7 = new Book("Cat", "Rock", 65, "000000000000000000000");
            string actualResult = book7.Isbn13;
            Assert.AreEqual(typeof(ArgumentException), actualResult);
        }

        [TestMethod]
        public void TestIsbn13MethodEqualsTo13()
        {
            Book book7 = new Book("Cat", "Rock", 65, "0000000000000");
            string actualResult = book7.Isbn13;
            Assert.AreEqual("0000000000000", actualResult);
        }
